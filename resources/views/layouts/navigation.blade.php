<nav x-data="{ open: false }" class="bg-[var(--color-store-secondary)] border-b border-gray-700 text-white">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-12 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{-- All administrative links are controlled by this Gate check --}}
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-black hover:text-white hover:bg-gray-800 focus:outline-none transition ease-in-out duration-150">
    ...
    <!-- Responsive Navigation Menu (Mobile/Hamburger View) -->
