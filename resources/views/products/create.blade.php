                ...
                <div class="p-6 text-[var(--color-store-text)]">
                    ...
                    <form action="{{ route('admin.products.store') }}" method="POST">
                        ...
                        <div class="flex items-center justify-end mt-4">
                            ...
                            <x-primary-button icon='<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>'>
                                {{ __('Save Product') }}
                            </x-primary-button>
                        </div>
                    </form>
